...
class TimeEmbedding(nn.Module):
    def __init__(self, embedding_dim, max_positions) -> None:
        super().__init__()
        assert embedding_dim % 2 == 0
        self.n_channel = embedding_dim
...
class EmoMiaoNet(nn.Module):
    ...
    def model_predict(
        ...
        deform_pa = output_tensors["deform_velocity"].squeeze().view(-1,3,3)
